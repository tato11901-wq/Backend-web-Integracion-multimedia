...
type GameState = "idle" | "loading" | "playing" | "submitting" | "finished" | "error"
...
export default function Sun() {
  ...
  const tierEmoji = TIER_EMOJIS[currentTier] ?? "📦"
      ...
      >
          ...
          <>
            <div class="bg-white/10 p-4 rounded-xl border border-white/20 text-center">
              <p class="text-white text-sm font-medium">
                Abre la caja con <strong>4 clicks</strong>.<br />
                Cada click puede subir el tier de la caja.<br />
                ¡El tier final determina cuántos soles obtienes!
              </p>
              <div class="mt-3 flex flex-col gap-1 text-xs text-white/70">
                <span>📦 Bronce → 🥇 Oro → 💎 Diamante → ☀️ Solar</span>
              </div>
            </div>
        ...
        {gameState === "playing" && (
          <>
            ...
            >
              <span class="text-2xl font-black">{tierEmoji} Tier {currentTier}</span>
            ...
            <button
              ...
              class={`text-8xl select-none transition-all duration-150 drop-shadow-lg
        ...
        {gameState === "finished" && reward !== null && (
          <div class="flex flex-col items-center gap-4 py-2">
            ...
            >
              <span class="text-lg">Tier alcanzado: {tierEmoji} {tierLabel}</span>
